...
final class FetchPaymentDataSuccessState extends StudentActionState {
  ...
  FetchPaymentDataSuccessState(
      {required this.PaymentData, required this.feeData});
}
...
final class CanPopTrueState extends StudentActionState {
  final int currentIndex;
  CanPopTrueState({required this.currentIndex});
}
