...
import 'package:schoolmate/view/student/fee/payment_history_widget.dart';
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              ' : PKR ${feeDatas[0]['total_amount']}',
                                              style: contentTextStyle,
                                            ),
                                            kHeight,
                                            Text(
                                              ' : PKR ${feeDatas[0]['amount_paid']}',
                                              style: contentTextStyle,
                                            ),
                                            kHeight,
                                            Text(
                                              ' : PKR ${feeDatas[0]['amount_pending']}',
                                              style: contentTextStyle,
                                            ),
                                          ],
                                        )
