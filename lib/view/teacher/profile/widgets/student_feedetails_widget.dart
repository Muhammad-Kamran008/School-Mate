...
import 'package:schoolmate/view/teacher/profile/fee/fee_edit_screen.dart';
import 'package:schoolmate/view/teacher/profile/widgets/shimmerloading_student_fee.dart';
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      ' : PKR ${feeData['total_amount']}',
                                      style: contentTextStyle,
                                    ),
                                    kHeight,
                                    Text(
                                      ' : PKR ${feeData['amount_paid']}',
                                      style: contentTextStyle,
                                    ),
                                    kHeight,
                                    Text(
                                      ' : PKR ${feeData['amount_pending']}',
                                      style: contentTextStyle,
                                    ),
                                  ],
                                )
